...
const Ready = () => {
  ...
  return (
    <div className=" max-w-[1200px] px-3 mx-auto ">
      <h2 className=" text-[30px] sm:text-[50px] font-semibold leading-[42px] sm:leading-[60px] text-center text-black max-w-[650px] mx-auto font-[Poppins]">
        Ready to get started with Lemon Wares?
      </h2>
      <p className=" text-[25px] font-normal leading-[25px] font-[Poppins] text-center text-black pt-3 sm:pt-9">
        Choose the package that suits you
      </p>
      <div className=" flex justify-center gap-8 items-center pt-4 sm:pt-14 flex-wrap">
        <p className="text-[25px] font-normal leading-[25px] font-[Poppins] text-black">
          Monthly
        </p>
        <span className="flex w-[93px] h-[50px] rounded-full bg-[#B00000] ml-8 mr-7 relative  items-center cursor-pointer">
          <span className="flex w-[30px] h-[30px] bg-white rounded-full absolute left-2"></span>
        </span>
        <p className="text-[25px] font-normal leading-[25px] font-[Poppins] text-black">
          Yearly
        </p>
        <p className=" text-[10px] font-[Poppins] font-medium text-black leading-[9px] max-w-[87px] max-h-[24px] rounded-lg bg-[#FFE87A] py-[7px] px-[8px]">
          20% discount
        </p>
      </div>
      <div className=" flex justify-center  relative pt-4 sm:pt-20 max-w-[856px] mx-auto w-full cursor-pointer">
        <span className=" border-bottom-2"></span>
        <div className= {`${data === "tab1" && "  relative before:h-[4px] cursor-pointer before:rounded-[10px] before:bg-[#B00000] before:absolute before:bottom-[-10%] before:w-full before:left-0"} flex w-1/2 justify-center`}>
          <p onClick={() => tabs('tab1')} className={` text-[30px] font-semibold leading-10 font-[Poppins] text-black`}>
            Basic
          </p>
        </div>
        <div className= {`${data === "tab2" && "  relative before:h-[4px] cursor-pointer before:rounded-[10px] before:bg-[#B00000] before:absolute before:bottom-[-10%] before:w-full before:left-0"} flex w-1/2 justify-center`}>
          <p onClick={() => tabs('tab2')} className={` text-[30px] font-semibold leading-10 font-[Poppins] text-black`}>
            Premium
          </p>
        </div>
      </div>
