...
const Websites = () => {
  return (
    <div className='max-w-[1220px] mx-auto px-3 bg-[#F7FAFE] rounded-2xl mb-10 sm:mb-[110px] relative'>
      <div className='   px-5 sm:px-12 lg:pl-[118px] lg:pr-[90px]'>
        ...
        <div className="flex justify-center pt-10 pb-5 md:pb-10 lg:pb-[88px] font-[Poppins] leading-6 text-sm font-normal">
          <button className='py-3 px-4 text-white bg-[#B00000] flex rounded-lg relative font-semibold font-sans after:-z-20 after:absolute after:h-1 after:w-1 hover:bg-white hover:text-black border border-transparent hover:border-black after:bg-white after:left-5 overflow-hidden after:bottom-0 after:translate-y-full after:rounded-md after:hover:scale-[300] after:hover:transition-all after:hover:duration-700 after:transition-all after:duration-700 transition-all duration-700'><span className=' mr-2'><Whatsapp/></span> Get  in touch with us</button></div>
      </div>
